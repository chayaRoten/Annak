...
int select1 = 0, select2 = 0, wait = 0, max_wait = INT_MAX;




void Game::start(Input& myInput, World& myWorld)
{
...
void Game::steps(Input& myInput, World& myWorld)
{
    while (wait < max_wait) {
...
void Game::asserts(Input& myInput, World& myWorld)
{
